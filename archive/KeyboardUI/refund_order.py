...
order_URL = environ.get('order_URL') or "http://order:5012/order"
shipping_record_URL = environ.get('shipping_record_URL') or "http://orderRefund:5014/orderRefund"
...
def processRefundOrder(order):
    ...
    inventory_URL = environ.get('inven_URL') or "http://inventory:5013/inventory"
    ...
    shipping_create_URL ="http://orderRefund:5014/orderRefund/create"
    ...
    update_order_url = 'http://order:5012/order/refund/' + str(orderid)
